(function ($) {
	...
	// project code
	$('body').on('click', '#price-update-success', function (e) {
		e.preventDefault();
		 new Noty({
			type: 'success',
			layout: 'topRight',
			text: 'Price Updated Success.',
			progressBar: true,
			timeout: 2500,
			animation: {
				open: 'animated bounceInRight', // Animate.css class names
	...
	$('body').on('click', '#price-update-faield-room', function (e) {
		e.preventDefault();
		 new Noty({
			type: 'error',
			layout: 'topRight',
	...
	$('body').on('click', '#price-update-faield-price', function (e) {
		e.preventDefault();
		 new Noty({
			type: 'error',
			layout: 'topRight',
